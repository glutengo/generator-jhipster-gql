...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_POST),
          REQUEST(ACTION_TYPES.UPDATE_POST),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_POST),
          REQUEST(ACTION_TYPES.DELETE_POST),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_POST),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_POST actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_POST),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_POST),
          payload: resolvedObject,
        },
      ];

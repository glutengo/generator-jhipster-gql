...
export class Config {
    ...
    'jhipster.mail.from' = 'news@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'news API';
    'jhipster.swagger.description' = 'news API documentation';
    ...
    'eureka.instance.appname' = 'news';
    'eureka.instance.instanceId' = 'news:${random.value}';

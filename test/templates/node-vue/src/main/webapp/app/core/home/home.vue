  ...
  <div class="home row">
    ...
    <div class="col-md-9">
      ...
      <ul>
        ...
        <li>
          <a
            href="https://github.com/jhipster/generator-jhipster-nodejs/issues?state=open"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <li>
          <a
            href="https://gitter.im/jhipster/generator-jhipster-nodejs"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <p>
        <span v-text="$t('home.like')">If you like NHipster, don't forget to give us a star on</span>
        <a href="https://github.com/jhipster/generator-jhipster-nodejs" target="_blank" rel="noopener noreferrer" v-text="$t('home.github')"
          >GitHub</a
        >!
      </p>
    </div>
